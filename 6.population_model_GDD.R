...
#kerncalc is from loading "source(kerncalc.R)", which is the dispersal Kernel from Häussler et al. 2017 
...
pop_param$Ne <- sum(values(nests), na.rm = TRUE) # to get the number of nests from the nest map
